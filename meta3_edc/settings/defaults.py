...
INSTALLED_APPS = [
    ...
    "meta3_sites.apps.AppConfig",
    "meta3_edc.apps.EdcFacilityAppConfig",
...
meta3_REGISTER_FILE = os.path.join(ETC_DIR, "meta3_register.csv")


# if running tests ...
if "test" in sys.argv or "runtests" in sys.argv:
    ETC_DIR = os.path.join(BASE_DIR, "meta3_edc", "tests", "etc")
    KEY_PATH = os.path.join(BASE_DIR, "meta3_edc", "tests", "etc")
    DJANGO_CRYPTO_FIELDS_TEMP_PATH = env("DJANGO_CRYPTO_FIELDS_TEMP_PATH")
    MIGRATION_MODULES = DisableMigrations()
    PASSWORD_HASHERS = ("django.contrib.auth.hashers.MD5PasswordHasher",)
    DEFAULT_FILE_STORAGE = "inmemorystorage.InMemoryStorage"
    meta3_REGISTER_FILE = os.path.join(TEST_DIR, "meta3_register.csv")
