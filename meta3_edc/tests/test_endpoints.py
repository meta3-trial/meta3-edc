...
from meta3_screening.models.subject_screening import SubjectScreening
from meta3_screening.tests.meta3_test_case_mixin import MetaTestCaseMixin
from meta3_sites.sites import all_sites, fqdn
...
class AdminSiteTest(MetaTestCaseMixin, WebTest):
    ...
    def test_ae(self):
        ...
        self.app.get(reverse("meta3_ae:home_url"), user=self.user, status=200)
    ...
    def test_screening_form(self):
        ...
        self.assertRedirects(page, reverse(f"{app_prefix}_dashboard:screening_listboard_url"))
    ...
    def test_to_subject_dashboard(self):
        ...
        subject_screening = baker.make_recipe("meta3_screening.subjectscreening")
        ...
        href = reverse(
            "meta3_dashboard:subject_dashboard_url",
