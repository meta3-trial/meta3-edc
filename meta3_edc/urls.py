...
from meta3_ae.admin_site import meta3_ae_admin
from meta3_consent.admin_site import meta3_consent_admin
from meta3_export.admin_site import meta3_export_admin
from meta3_lists.admin_site import meta3_lists_admin
from meta3_prn.admin_site import meta3_prn_admin
from meta3_screening.admin_site import meta3_screening_admin
from meta3_subject.admin_site import meta3_subject_admin
...
urlpatterns = [
    ...
    path("admin/", meta3_consent_admin.urls),
    path("admin/", meta3_subject_admin.urls),
    path("admin/", meta3_ae_admin.urls),
    path("admin/", meta3_lists_admin.urls),
    path("admin/", meta3_export_admin.urls),
    path("admin/", meta3_prn_admin.urls),
    path("admin/", meta3_screening_admin.urls),
    ...
    path(
        "admin/meta3_subject/",
        RedirectView.as_view(url="admin/meta3_subject/"),
        name="subject_models_url",
    ),
    path("meta3_consent/", include("meta3_consent.urls")),
    path("meta3_subject/", include("meta3_subject.urls")),
    path("meta3_ae/", include("meta3_ae.urls")),
    path("meta3_export/", include("meta3_export.urls")),
    path("meta3_lists/", include("meta3_lists.urls")),
    path("meta3_prn/", include("meta3_prn.urls")),
    path("meta3_screening/", include("meta3_screening.urls")),
    path("subject/", include("meta3_dashboard.urls")),
