...
from meta3_dashboard.navbars import navbar as meta3_dashboard_navbar
...
navbar.append_item(
    [item for item in meta3_dashboard_navbar.items if item.name == "screened_subject"][0]
)

navbar.append_item(
    [item for item in meta3_dashboard_navbar.items if item.name == "consented_subject"][0]
)
